...
from data.vigor_dataloader_double import load_VIGOR_data
...
def main(args):
    ...
    train_dataloader = load_VIGOR_data(dataset_config.batch_size_train, stage='train')
    val_dataloader = load_VIGOR_data(dataset_config.batch_size_train, stage='val')

...
class OmniGaussianCylinderVolume360LocPan(BaseModule):
    ...
    def forward(self, batch, split="train", iter=0, iter_end=100000):
        ...
        if split == "train" or split == "val":
            render_pkg_volume = render_pkg_pixel = render_pkg_fuse
        else:
            render_pkg_pixel, render_pkg_volume = None, None# b v 1 h w
        ...
        return loss, loss_terms, render_pkg_fuse, render_pkg_pixel, render_pkg_volume, render_pkg_pixel, gaussians_pixel, gaussians_pixel, data_dict

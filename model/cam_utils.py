...
class MiniCam:
    def __init__(self, image_height, image_width, tan_half_fovx, tan_half_fovy, world_view_transform, full_proj_transform, camera_center, device):
        # c2w (pose) should be in NeRF convention.

        self.image_width = image_width
        self.image_height = image_height
        self.tan_half_fovx = tan_half_fovx
        self.tan_half_fovy = tan_half_fovy

...
resume_from = '/home/qiwei/ICLR25/workdirs/omni_gs_160x320_mp3d_cylinder_double_pixel_unifuse/checkpoint-3000/model.safetensors'
# resume_from = False
...
model = dict(
    type='OmniGaussianCylinderPixelUniFuse',

...
resume_from = '/data/qiwei/nips25/workdirs/omni_gs_160x320_mp3d_cylinder_double_volume_unifuse/checkpoint-36000/model.safetensors'
# resume_from = False
...
model = dict(
    type='OmniGaussianCylinderAllUniFuse',

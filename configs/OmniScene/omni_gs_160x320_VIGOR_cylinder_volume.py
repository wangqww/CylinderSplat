...
resume_from = '/data/qiwei/nips25/workdirs/omni_gs_160x320_VIGOR_cylinder_double_pixel/checkpoint-3000/model.safetensors'
# resume_from = False
...
point_cloud_range = [0.0, 0.0, -10.0, 80.0, 6.28, 5.0] # r, phi, z
scale_theta = 1
scale_r = 1
scale_z = 1
